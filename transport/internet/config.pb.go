...
type SocketConfig struct {
	...
	DiscardXForwardedFor       bool                 `protobuf:"varint,23,opt,name=discard_x_forwarded_for,json=discardXForwardedFor,proto3" json:"discard_x_forwarded_for,omitempty"`
}
...
func (x *SocketConfig) GetDiscardXForwardedFor() bool {
	if x != nil {
		return x.DiscardXForwardedFor
	}
	return false
}
...
var file_transport_internet_config_proto_rawDesc = []byte{
	...
	0x45, 0x79, 0x65, 0x62, 0x61, 0x6c, 0x6c, 0x73, 0x12, 0x35, 0x0a, 0x17, 0x64, 0x69, 0x73, 0x63,
	0x61, 0x72, 0x64, 0x5f, 0x78, 0x5f, 0x66, 0x6f, 0x72, 0x77, 0x61, 0x72, 0x64, 0x65, 0x64, 0x5f,
	0x66, 0x6f, 0x72, 0x18, 0x17, 0x20, 0x01, 0x28, 0x08, 0x52, 0x14, 0x64, 0x69, 0x73, 0x63, 0x61,
	0x72, 0x64, 0x58, 0x46, 0x6f, 0x72, 0x77, 0x61, 0x72, 0x64, 0x65, 0x64, 0x46, 0x6f, 0x72, 0x22,
